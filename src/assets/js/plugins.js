  ...
  r.prototype = {
    ...
    _process_options: function (e) {
      ...
      var s = (this.o = t.extend({}, this._o)),
        n = s.language;
      p[n] || ((n = n.split("-")[0]), p[n] || (n = c.language)),
        (s.language = n),
      ...
      if (
        ...
        t.isArray(s.daysOfWeekHighlighted) ||
    ...
    show: function () {
      if (
        !(this.component ? this.element.find("input") : this.element).attr(
          "readonly"
        ) ||
    ...
    place: function () {
      ...
      var e = this.picker.outerWidth(),
        ...
        s = a.width(),
        n =
          "body" === this.o.container ? t(document).scrollTop() : a.scrollTop(),
        o = a.offset(),
        r = [];
      ...
      "body" !== this.o.container && (p += n),
        ...
        "auto" !== this.o.orientation.x
          ...
          : u + e > s
          ? (this.picker.addClass("datepicker-orient-right"), (u += c - e))
          : this.picker.addClass("datepicker-orient-left");
      var f = this.o.orientation.y;
      if (
        ("auto" === f && (f = 0 > -n + p - i ? "bottom" : "top"),
    ...
    fillMonths: function () {
      for (var t = this._utc_to_local(this.viewDate), e = "", i = 0; 12 > i; ) {
        e +=
          ...
          '">' +
          p[this.o.language].monthsShort[i++] +
          "</span>";
      }
    ...
    getClassNames: function (e) {
      ...
      return (
        ...
        (!this.dateWithinRange(e) || this.dateIsDisabled(e)) &&
          i.push("disabled"),
    ...
    fill: function () {
      ...
      if (!isNaN(o) && !isNaN(r)) {
        this.picker
          .find(".datepicker-days .datepicker-switch")
          .text(f.formatDate(n, D, this.o.language)),
          this.picker
            .find("tfoot .today")
            .text(u)
        ...
        for (var w, k = []; m.valueOf() < y; ) {
          if (
            ...
            var C = new Date(
              ...
              b = new Date(
                Number((b = i(_.getUTCFullYear(), 0, 1))) +
          ...
          (w = this.getClassNames(m)).push("day"),
            this.o.beforeShowDay !== t.noop &&
              ((s = this.o.beforeShowDay(this._utc_to_local(m))) === e
                ? (s = {})
                : "boolean" == typeof s
                ? (s = { enabled: s })
    ...
    click: function (e) {
      ...
      c.length > 0 &&
        ((n = f.modes[this.viewMode].navStep * (c.hasClass("prev") ? -1 : 1)),
        0 === this.viewMode
        ...
        s.hasClass("disabled") ||
          ...
          s.hasClass("month") &&
            ...
            1 === this.o.minViewMode
              ? (this._setDate(i(r, h, o)), this.showMode())
              : this.showMode(-1),
            this.fill()),
          (s.hasClass("year") ||
            s.hasClass("decade") ||
    ...
    showMode: function (t) {
      t &&
        (this.viewMode = Math.max(
          this.o.minViewMode,
          Math.min(this.o.maxViewMode, this.viewMode + t)
        )),
        this.picker
          .children("div")
          .hide()
        ...
        this.each(function () {
          ...
          if (!n) {
            var l = (function (e, i) {
                ...
                for (var h in n)
                  i.test(h) && ((s = h.replace(r, a)), (o[s] = n[h]));
                return o;
              })(this, "date"),
              d = (function (e) {
                var i = {};
              ...
              f = t.extend({}, c, d, l, o);
            e.hasClass("input-daterange") || f.inputs
              ? (t.extend(f, { inputs: f.inputs || e.find("input").toArray() }),
                (n = new h(this, f)))
              : (n = new r(this, f)),
              e.data("datepicker", n);
          }
  ...
  var p = (t.fn.datepicker.dates = {
    ...
    f = {
      ...
      parseDate: function (s, n, o, h) {
        ...
        if (("string" == typeof n && (n = f.parseFormat(n)), n.toValue))
        ...
        var c,
          ...
          m = /([\-+]\d+)([dmwy])/,
          v = s.match(/([\-+]\d+)([dmwy])/g),
          y = { d: "moveDay", m: "moveMonth", w: "moveWeek", y: "moveYear" },
          w = { yesterday: "-1d", today: "+0d", tomorrow: "+1d" };
        if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(s)) {
          for (s = new Date(), g = 0; g < v.length; g++)
            (c = m.exec(v[g])),
              (u = parseInt(c[1])),
              (D = y[c[2]]),
              (s = r.prototype[D](s, u));
        ...
        if (
          ...
          for (g = 0, U = M.length; U > g; g++) {
            if (((k = parseInt(v[g], 10)), (c = M[g]), isNaN(k)))
              switch (c) {
                case "MM":
          ...
          for (g = 0; g < b.length; g++)
            (F = b[g]),
              F in _ &&
                !isNaN(_[F]) &&
                ((x = new Date(s)), T[F](x, _[F]), isNaN(x) || (s = x));
        }
        return s;
      },
      formatDate: function (e, i, a) {
        if (!e) return "";
        if (("string" == typeof i && (i = f.parseFormat(i)), i.toDisplay))
        ...
        (s.dd = (s.d < 10 ? "0" : "") + s.d),
          ...
          (e = []);
        for (
          var n = t.extend([], i.separators), o = 0, r = i.parts.length;
          r >= o;
          o++
        )
          ...
          try {
            ...
            for (var k = "", f = "", g = "", m = 0; m < u.length; m++) {
              ...
              switch (((g = ""), (k += M))) {
                ...
                case "MMMM":
                  (f +=
                    ((v = o), void 0, (S = parseInt(v, 10) - 1), t[S] || v)),
                    (k = "");
                  break;
                case "MMM":
                  if ("M" === u.charAt(m + 1)) break;
                  (f +=
                    ((A = o), void 0, (D = parseInt(A, 10) - 1), r[D] || A)),
                    (k = "");
                  break;
                case "MM":
                  if ("M" == u.charAt(m + 1)) break;
        ...
        prettyDate: function (e) {
          ...
          if (
            ...
            return t >= 31
              ? "more than 31 days"
              : (0 == t &&
                  ((r < 60 ? "just now" : r < 120 && "1 minute ago") ||
                    (r < 3600 && Math.floor(r / 60) + " minutes ago") ||
                    (r < 7200 && "1 hour ago") ||
                    (r < 86400 && Math.floor(r / 3600) + " hours ago"))) ||
                  (1 == t && "Yesterday") ||
                  (t < 7 && t + " days ago") ||
  ...
  var t,
    ...
    s =
      ...
      (a = {
        ...
        Elastic: function (t, n) {
          ...
          return (
            -Math.pow(2, 10 * r) *
            Math.sin(
              (2 * (r - (e / (2 * Math.PI)) * Math.asin(1)) * Math.PI) / e
            )
          );
        },
        Back: function (t) {
        ...
        Bounce: function (t) {
          ...
          return (
            1 / Math.pow(4, 3 - e) - 7.5625 * Math.pow((3 * n - 2) / 22 - t, 2)
          );
        },
      }),
      ...
      Object.keys(a).forEach(function (t) {
        var n = a[t];
        (r["easeIn" + t] = n),
          (r["easeOut" + t] = function (t, e) {
            return 1 - n(1 - t, e);
          }),
          (r["easeInOut" + t] = function (t, e) {
            return 0.5 > t ? n(2 * t, e) / 2 : 1 - n(-2 * t + 2, e) / 2;
          }),
    ...
    x = function (t, n) {
      if (n in t.style)
        return getComputedStyle(t).getPropertyValue(f(n)) || "0";
    },
    w = function (t, n) {
      return i.dom(t) && m(u, n)
        ? "transform"
    ...
    O = function (t, n, e) {
      return i.col(n)
        ...
        : y(n)
        ? n
        : (!(t = y(t.to) ? y(t.to) : y(t.from)) && e && (t = y(e)),
          t ? n + t : n);
    },
    k = function (t) {
      var n = /-?\d*\.?\d+/g;
          ...
          (e = t).forEach(function (t, n) {
            ...
            return r.forEach(function (r) {
              ...
              if (u) {
                ...
                (s = {
                  from:
                    1 < (c = p(i.fnc(c) ? c(o, n) : c)).length ? c[0] : M(o, s),
                  to: 1 < c.length ? c[1] : c[0],
                }),
                  ((c = g(r)).animatables = t),
                  (c.type = u),
                  (c.from = E(r.name, s, c.type, o).from),
                  (c.to = E(r.name, s, c.type, o).to),
                  (c.round = i.col(s.from) || c.round ? 1 : 0),
                  (c.delay =
                    (i.fnc(c.delay) ? c.delay(o, n, e.length) : c.delay) /
                    N.speed),
                  (c.duration =
                    (i.fnc(c.duration)
                      ? c.duration(o, n, e.length)
                      : c.duration) / N.speed),
                  a.push(c);
              }
            });
      ...
      return (
        t.tweens.forEach(function (t) {
          ("css" !== t.type && "transform" !== t.type) ||
            (n.push("css" === t.type ? f(t.name) : "transform"),
    ...
    P = function (t, n) {
      var e,
        r,
        a,
        o = Math.min(Math.max(n - t.delay, 0), t.duration) / t.duration,
            ...
            ? (function (t, n) {
                var e = t.path,
                  ...
                  a = (u = function (a) {
                    return (
                      (a = a || 0),
                      e.getPointAtLength(1 < n ? t.value + a : r + a)
                    );
                  })(),
                  o = u(-1),
                  u = u(1);
    ...
    C = function (n, e) {
      ...
      if (r)
        for (a in (t ||
          (t = (x(document.body, "transform") ? "" : "-webkit-") + "transform"),
        r))
          n.animatables[a].target.style[t] = r[a].join(" ");
      n.settings.update && n.settings.update(n);
    },
    S = function (t) {
      var n,
        e = {};
      (e.animatables = (n = (n = t.targets)
        ? d(i.arr(n) ? n.map(p) : p(n))
        : []).map(function (t, n) {
      ...
      for (r in t)
        if (!o.hasOwnProperty(r) && "targets" !== r) {
          var s = i.obj(t[r]) ? g(t[r]) : { value: t[r] };
          (s.name = r), u.push(v(s, a));
        }
      return (
        (e.properties = u),
        (e.tweens = I(e.animatables, e.properties)),
        (e.duration =
          (function (t) {
            if (t.length)
      ...
      return (
        (n.tick = function (t) {
          (n.ended = !1),
            ...
            C(n, e.current);
          var r = n.settings;
          r.begin && e.current >= r.delay && (r.begin(n), (r.begin = void 0)),
            e.current >= n.duration &&
              (r.loop
                ? ((e.start = t),
                  "alternate" === r.direction && A(n, !0),
                  i.num(r.loop) && r.loop--)
        ...
        (n.play = function (t) {
          var r;
          n.pause(),
            t && (n = v(S(v(t, n.settings)), n)),
            (e.start = 0),
            (e.last = n.ended ? 0 : n.currentTime),
            "reverse" === (t = n.settings).direction && A(n),
            "alternate" !== t.direction || t.loop || (t.loop = 1),
            (r = j(n)).elements.forEach(function (t) {
    ...
    (N.remove = function (t) {
      ...
      for (var n = T.length - 1; 0 <= n; n--)
        for (var e = T[n], r = e.tweens, a = r.length - 1; 0 <= a; a--)
          for (var o = r[a].animatables, u = o.length - 1; 0 <= u; u--)
            m(t, o[u].target) &&
              (o.splice(u, 1),
              o.length || r.splice(a, 1),
              r.length || e.pause());
    }),
    (N.easings = s),
    (N.getValue = M),
    (N.path = function (t) {
      return { path: (t = i.str(t) ? l(t)[0] : t), value: t.getTotalLength() };
    }),
    ...
    (n.prototype.reveal = function (e) {
      ...
      var c = this,
        ...
        v = {
          delay: e.delay || n,
          complete: function () {
            (c.revealer.style.WebkitTransformOrigin =
              c.revealer.style.transformOrigin =
                l.origin.halfway),
